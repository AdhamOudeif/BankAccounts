...
{ 
    ...
    { 
        ...
        System.out.println("total number of deposits for the day are " + (acct1.getNumDeposits() + acct2.getNumDeposits()));

        //Print number of withdrawals for the day
        System.out.println("total number of withdrawls for the day are " + (acct1.getNumWithdraws() + acct2.getNumDeposits()));
        //Print total amount of deposits for the day
        System.out.println("total amount of deposits for the day are " + (acct1.getTotalDeposits() + acct2.getTotalDeposits())); 
        //Print total amount of withdrawals for the day
        System.out.println("total amount of withdrawls for the day are " + (acct1.getTotalWithdrawn() + acct2.getTotalWithdrawn()));
    } 
}
